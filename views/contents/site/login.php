...
<?php else: ?>
  ...
  <div id="contenitore">
    <div style="margin-left: 200px; margin-top: 10px; position: absolute;">
      ...
      <p>Una volta costruito il centro del villaggio, potrai procedere con la caserma, se vorrai attaccare i villaggi nemici, oppure con il  mercato, per effettuare scambi commerciali.</p>
      <h1>Attenzione!</h1>
